...
const LandingDustEffect = preload("res://src/map/town/effect/LandingDustEffect.tscn")
...
var player_entering_door = false
var game_board
...
func entered_door():
	print('entering door from player')
...
func move(delta):
	...
	if door_ray.is_colliding():
		...
		if !player_entering_door:
			player_entering_door = true
			emit_signal("player_entering_door_signal")
		percent_moved_to_next_tile += walk_speed * delta
		if percent_moved_to_next_tile >= 1.0:
			player_entering_door = false
