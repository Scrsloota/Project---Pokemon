...
const grass_overlay_texture = preload("res://assets/map/grass/stepped_tall_grass.png")
const GrassStepEffect = preload("res://src/map/town/effect/GrassStepEffect.tscn")
...
func player_in_grass():
	if player_inside == true:
		if RandomGenerater.generate_random() == true:
			get_node("StartCombat").interact()
#		print(RandomGenerater.count)
